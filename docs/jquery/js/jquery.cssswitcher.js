...
* required Cookie Plugin (https://github.com/carhartl/jquery-cookie)
*/

var CssSwitcher = {
  // Settings
  cssPath : "css/", // http://domain/path/to/css/
  idList : [ 'font', 'color', 'tag', 'parts' ], // List up id attribute of 'stylesheet' rel attribute
  // Cookie Settings
  domain : "",
  path : "/",
